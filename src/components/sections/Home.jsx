  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative">
        <div className="text-center z-10 px-4">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent leading-right">Hi, I'm Yvan Hirwa</h1>

            <p className="text-gray-400 text-lg mb-9 max-w-lg mx-auto">
                I'm a passionate software engineer with a knack for creating innovative solutions. 
